/**
 * This is a file with standard macros for printing and asserting with a fail
 * message
 */
#pragma once
...
#define LOG(msg)                                                          \
    fprintf(stdout, "(File: %s, Function: %s, line: %d): %s\n", __FILE__, \
            __FUNCTION_NAME__, __LINE__, msg)

// print a integer message
#define LOG_D(integer)                                                    \
    fprintf(stdout, "(File: %s, Function: %s, line: %d): %d\n", __FILE__, \
            __FUNCTION_NAME__, __LINE__, integer)

// print a char message
#define LOG_C(character)                                                  \
    fprintf(stdout, "(File: %s, Function: %s, line: %d): %c\n", __FILE__, \
            __FUNCTION_NAME__, __LINE__, character)

// print a size_t message
#define LOG_ZU(size)                                                       \
    fprintf(stdout, "(File: %s, Function: %s, line: %d): %zu\n", __FILE__, \
            __FUNCTION_NAME__, __LINE__, size)

// print a size_t message
#define LOG_F(size)                                                       \
    fprintf(stdout, "(File: %s, Function: %s, line: %d): %f\n", __FILE__, \
            __FUNCTION_NAME__, __LINE__, size)
...
#define OK(msg)                                                                \
    fprintf(stdout, "(File: %s, Function: %s, line: %d) - OK: %s\n", __FILE__, \
            __FUNCTION_NAME__, __LINE__, msg)
